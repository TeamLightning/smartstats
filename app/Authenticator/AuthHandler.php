...
class AuthHandler {
    ...
    public function register($req, $res, $args)
    {
        ...
        try {
            ...
            return $this->view('auth/register', [
                'error' => 'Email delivery failed. Please contact the developer with the email you register now'
            ], $res);
        }
        catch (InvalidEmailException $e) {
            return $this->view('auth/register', [
        ...
        catch (InformationSavingError $e) {
            return $this->view('auth/register', [
                'error' => 'Oops, there was an issue with the servers. Try again after some time'
            ], $res);
        }
    }
